...
export default function NewsAggregationPage() {
  ...
  const project = {
    ...
    fullDescription:
      "A comprehensive news aggregation platform that leverages Scrapy's high-performance web scraping capabilities to collect, process, and analyze news content from hundreds of sources in real-time. The system provides intelligent content categorization, sentiment analysis, and trend detection.",
    image: "/placeholder.svg?height=600&width=1200&text=News+Aggregation+Platform",
    images: [
      "/placeholder.svg?height=400&width=600&text=News+Dashboard",
      "/placeholder.svg?height=400&width=600&text=Scrapy+Pipeline+Monitor",
      "/placeholder.svg?height=400&width=600&text=Content+Analysis+View",
      "/placeholder.svg?height=400&width=600&text=Trend+Detection+Panel",
    ],
    tags: ["Python", "Scrapy", "Redis", "Elasticsearch", "Kafka", "Docker"],
    liveUrl: "https://news-aggregation-demo.com",
    githubUrl: "https://github.com/quarksol/news-aggregation",
    duration: "5 months",
    teamSize: "5 developers",
    client: "Media Intelligence Corp",
    year: "2024",
    featured: true,
    challenges: [
      "Handling massive scale with 1000+ news sources",
      "Real-time processing of high-volume data streams",
      "Duplicate content detection and deduplication",
      "Maintaining scraping efficiency while respecting robots.txt",
    ],
    solutions: [
      "Implemented Scrapy with distributed crawling architecture",
      "Built real-time data pipeline using Apache Kafka",
      "Created advanced duplicate detection using content hashing",
      "Developed intelligent rate limiting and politeness policies",
    ],
    results: [
      "Processes 500K+ articles daily",
      "Achieves 99.5% uptime reliability",
      "Reduces content discovery time by 90%",
      "Serves 10M+ API requests per day",
    ],
    testimonial: {
      text: "This platform has revolutionized how we monitor global news. The speed and accuracy of content aggregation is unmatched in the industry.",
      author: "Robert Kim",
      position: "VP of Technology, Media Intelligence Corp",
    },
    technicalDetails: [
      {
        title: "Scrapy Framework",
        description: "High-performance web scraping with advanced pipeline processing",
        features: [
          "Distributed spider architecture",
          "Custom middleware for anti-detection",
      ...
      },
      {
        ...
        description: "Stream processing pipeline for immediate content analysis",
        features: [
      ...
      },
      {
        ...
        description: "Enterprise-grade architecture for high-volume processing",
        features: [
          "Horizontal scaling with Docker Swarm",
          "Load balancing across spider instances",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                <Badge className="bg-gradient-to-r from-amber-600/20 to-orange-600/20 text-amber-300 border-amber-500/30 px-3 py-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  className="bg-gradient-to-r from-amber-600 to-orange-700 hover:from-amber-700 hover:to-orange-800 text-white font-semibold px-8 py-3 rounded-xl shadow-xl shadow-amber-600/25 hover:shadow-amber-600/40 transition-all duration-300 transform hover:scale-105"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="border-slate-600 text-slate-300 hover:bg-slate-800/50 bg-transparent backdrop-blur-sm px-8 py-3 rounded-xl font-semibold hover:border-amber-500 hover:text-white transition-all duration-300"
                >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {project.technicalDetails.map((detail, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm border border-slate-700/50 hover:border-amber-500/30 transition-all duration-500"
              >
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {project.tags.map((tag, index) => (
              <Badge
                key={index}
                className="bg-gradient-to-r from-slate-800/80 to-slate-900/80 text-slate-200 border-slate-700/50 px-4 py-2 text-sm font-medium hover:border-amber-500/50 transition-colors"
              >
                {tag}
              </Badge>
            ))}
      ...
      <section className="relative py-16 px-4 sm:px-6">
        <div className="container mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-12 text-center">
            Results &{" "}
            <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">Impact</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {project.results.map((result, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 hover:border-amber-500/30 transition-all duration-300 transform hover:scale-105 text-center"
              >
                <CardContent className="p-6">
        ...
        <div className="container mx-auto">
          <Card className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 max-w-4xl mx-auto">
            <CardContent className="p-8 sm:p-12 text-center">
              <div className="text-4xl sm:text-6xl text-amber-400 mb-6">"</div>
      ...
      <section className="relative py-16 px-4 sm:px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-300 mb-12 max-w-2xl mx-auto">
            Let's discuss how we can build a custom news aggregation platform for your business needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            <Link href="/contact">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-amber-600 to-orange-700 hover:from-amber-700 hover:to-orange-800 text-white font-semibold px-8 py-4 rounded-xl shadow-xl shadow-amber-600/25 hover:shadow-amber-600/40 transition-all duration-300 transform hover:scale-105"
              >
            ...
            <Link href="/portfolio">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-2 border-slate-600 text-slate-300 hover:bg-slate-800/50 bg-transparent backdrop-blur-sm px-8 py-4 rounded-xl font-semibold hover:border-amber-500 hover:text-white transition-all duration-300"
              >
